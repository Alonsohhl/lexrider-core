...
function osf_theme_custom_css() {
	$a1root      = include trailingslashit( LEXRIDER_CORE_PLUGIN_DIR ) . 'inc/customize/a1root.php';
	$grid        = include trailingslashit( LEXRIDER_CORE_PLUGIN_DIR ) . 'inc/customize/grid.php';
	$main_menu   = include trailingslashit( LEXRIDER_CORE_PLUGIN_DIR ) . 'inc/customize/main-menu.php';
	$button      = include trailingslashit( LEXRIDER_CORE_PLUGIN_DIR ) . 'inc/customize/button.php';
	$error_404   = include trailingslashit( LEXRIDER_CORE_PLUGIN_DIR ) . 'inc/customize/error-404.php';
	$heading     = include trailingslashit( LEXRIDER_CORE_PLUGIN_DIR ) . 'inc/customize/heading.php';
	$main_layout = include trailingslashit( LEXRIDER_CORE_PLUGIN_DIR ) . 'inc/customize/main-layout.php';
	$page_bg     = include trailingslashit( LEXRIDER_CORE_PLUGIN_DIR ) . 'inc/customize/page-bg.php';
	$page_title  = include trailingslashit( LEXRIDER_CORE_PLUGIN_DIR ) . 'inc/customize/page-title.php';
	//$sidebar     = include trailingslashit( LEXRIDER_CORE_PLUGIN_DIR ) . 'inc/customize/sidebar.php';
	//$widget      = include trailingslashit( LEXRIDER_CORE_PLUGIN_DIR ) . 'inc/customize/widget.php';
	$css
	             = <<<CSS
{$a1root}
{$grid}
