    ...
    class Osf_WooCommerce_Clever {
        ...
        public function add_hook() {
            if (function_exists('woosq_init') && get_option('woosq_button_position') == "0") {
                add_action('woocommerce_before_shop_loop_item_title', [$this, 'quickview_button'], 25);
            }

            if (function_exists('woosc_init')) {
                add_filter('woosc_button_position_archive', '__return_false');
                add_action('woocommerce_before_shop_loop_item_title', [$this, 'compare_button'], 35);

                if (get_option('_wooscp_button_single') == "0") {
                    add_action('woocommerce_after_add_to_cart_button', [$this, 'compare_button'], 10);
                }
            ...
            if (function_exists('woosw_init')) {
                if (get_option('woosw_button_position_archive') == "0") {
                    add_action('woocommerce_before_shop_loop_item_title', [$this, 'wishlist_button'], 30);
                }
