...
class OSF_Ajax_Load_More {
	...
	public function add_control_ajax_load_more( $widget, $condition = array() ) {
		$widget->start_controls_section(
			...
			[
				'label'     => __( 'Ajax Load More', 'lexrider-core' ),
		...
		$widget->add_control(
			'ajax_show',
			[
				'label' => __( 'Enable load more', 'lexrider-core' ),
		...
		$widget->add_control(
			'button_label',
			[
				'label'     => __( 'Button Label', 'lexrider-core' ),
		...
		$widget->add_control(
			...
			[
				'label'     => __( 'Button Loading Label', 'lexrider-core' ),
				'type'      => Controls_Manager::TEXT,
				'condition' => [
					'ajax_show' => 'yes'
				]
		...
		$widget->add_control(
			'ajax_scroll',
			[
				'label'        => __( 'Enable Scrolling', 'lexrider-core' ),
				'type'         => Controls_Manager::SWITCHER,
				'description'  => __( 'Load more posts as the user scrolls the page.', 'lexrider-core' ),
				'default'      => 'false',
				'return_value' => 'true',
				'condition'    => [
					'ajax_show' => 'yes'
		...
		$widget->start_controls_section(
			'section_ajax_style',
			[
				'label'     => __( 'Load More Button', 'lexrider-core' ),
		...
		$widget->add_group_control(
			...
			[
				...
				'label'    => __( 'Button Typo', 'lexrider-core' ),
			]
		);
