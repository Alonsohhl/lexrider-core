...
class OSF_Elementor_Image_Layers_Widget extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section('img_layers_content',
            [
                'label' => esc_html__('Images', 'lexrider-core'),
            ]
        );
        ...
        $repeater->add_control('layers_select',
            [
                'label'   => esc_html__('Select Content', 'lexrider-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'image' => esc_html__('Image Content', 'lexrider-core'),
                    'text'  => esc_html__('Text Content', 'lexrider-core'),
                ],
                'default' => 'image'
            ]
        );
        ...
        $repeater->add_control('img_layers_image',
            [
                'label'     => esc_html__('Upload Image', 'lexrider-core'),
        ...
        $repeater->add_control('img_layers_alt',
            [
                'label'       => esc_html__('Alt', 'lexrider-core'),
        ...
        $repeater->add_control('text_layers',
            [
                'label'     => esc_html__('Content', 'lexrider-core'),
                'type'      => Controls_Manager::TEXTAREA,
                'default'   => __('Lorem ipsum dolor sit amet', 'lexrider-core'),
                'condition' => [
                    'layers_select' => 'text'
                ]
            ]
        ...
        $repeater->add_control('img_layers_position',
            [
                'label'   => esc_html__('Position', 'lexrider-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'relative' => esc_html__('Relative', 'lexrider-core'),
                    'absolute' => esc_html__('Absolute', 'lexrider-core'),
                ],
                'default' => 'relative'
            ]
        );
        ...
        $repeater->add_responsive_control('img_layers_hor_position',
            [
                'label'       => esc_html__('Horizontal Offset', 'lexrider-core'),
                'type'        => Controls_Manager::SLIDER,
                'description' => esc_html__('Mousemove Interactivity works only with pixels', 'lexrider-core'),
                'size_units'  => ['px', "em", '%'],
                'range'       => [
                    'px' => [
                        'min' => -200,
        ...
        $repeater->add_responsive_control('img_layers_ver_position',
            [
                'label'       => esc_html__('Vertical Offset', 'lexrider-core'),
                'description' => esc_html__('Mousemove Interactivity works only with pixels', 'lexrider-core'),
                'type'        => Controls_Manager::SLIDER,
                'size_units'  => ['px', "em", '%'],
                'range'       => [
        ...
        $repeater->add_control('img_layers_rotate',
            [
                'label' => esc_html__('Rotate', 'lexrider-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $repeater->add_control('img_layers_rotatex',
            [
                'label'       => esc_html__('Degrees', 'lexrider-core'),
                'type'        => Controls_Manager::NUMBER,
                'description' => esc_html__('Set rotation value in degress', 'lexrider-core'),
                'min'         => -180,
                'max'         => 180,
                'condition'   => [
        ...
        $repeater->add_control('img_layers_animation',
            [
                'label'              => esc_html__('Entrance Animation', 'lexrider-core'),
        ...
        $repeater->add_control('img_layers_animation_duration',
            [
                ...
                'default'   => '',
                'options'   => [
                    'slow' => __('Slow', 'lexrider-core'),
                    ''     => __('Normal', 'lexrider-core'),
                    'fast' => __('Fast', 'lexrider-core'),
                ],
                'condition' => [
                    'img_layers_animation_switcher' => 'yes',
        ...
        $repeater->add_control('img_layers_animation_delay',
            [
                'label'              => esc_html__('Animation Delay', 'lexrider-core') . ' (s)',
                'type'               => Controls_Manager::NUMBER,
                'default'            => '',
                'min'                => 0,
                'step'               => 0.1,
        ...
        $repeater->add_control('img_layers_mouse',
            [
                'label'       => esc_html__('Mousemove Interactivity', 'lexrider-core'),
                'type'        => Controls_Manager::SWITCHER,
                'description' => esc_html__('Enable or disable mousemove interaction', 'lexrider-core'),
            ]
        );

        $repeater->add_control('img_layers_mouse_type',
            [
                'label'       => esc_html__('Interactivity Style', 'lexrider-core'),
                'type'        => Controls_Manager::SELECT,
                'options'     => [
                    'parallax' => esc_html__('Mouse Parallax', 'lexrider-core'),
                    'tilt'     => esc_html__('Tilt', 'lexrider-core'),
                ],
                'default'     => 'parallax',
                'label_block' => true,
                'condition'   => [
        ...
        $repeater->add_control('img_layers_rate',
            [
                'label'       => esc_html__('Rate', 'lexrider-core'),
                'type'        => Controls_Manager::NUMBER,
                'default'     => -10,
                'min'         => -20,
                'max'         => 20,
                'step'        => 1,
                'description' => esc_html__('Choose the movement rate for the layer image, default: -10', 'lexrider-core'),
                'separator'   => 'after',
                'label_block' => true,
                'condition'   => [
                    'img_layers_mouse'      => 'yes',
        ...
        $repeater->add_control('img_layers_zindex',
            [
                'label'     => esc_html__('z-index', 'lexrider-core'),
                'type'      => Controls_Manager::NUMBER,
                'default'   => 1,
                'selectors' => [
        ...
        $repeater->add_control('img_layers_class',
            [
                'label'       => esc_html__('CSS Classes', 'lexrider-core'),
                'type'        => Controls_Manager::TEXT,
                'description' => esc_html__('Separate class with spaces', 'lexrider-core'),
            ]
        );
