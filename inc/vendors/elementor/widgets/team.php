...
class OSF_Elementor_Team extends OSF_Elementor_Carousel_Base {
    ...
    public function get_title() {
        return __('Opal Teams', 'lexrider-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'options',
            [
                'label' => __('Additional Options', 'lexrider-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'style-1',
                'options' => array(
                    'style-1' => esc_html__('Style 1', 'lexrider-core'),
                    'style-2' => esc_html__('Style 2', 'lexrider-core'),
                    'style-3' => esc_html__('Style 3', 'lexrider-core'),
                ),
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Information', 'lexrider-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'social_color',
            [
                'label'     => __('Social Color', 'lexrider-core'),
                'type'      => Controls_Manager::COLOR,
                'scheme'    => [
                    'type'  => Scheme_Color::get_type(),
                    'value' => Scheme_Color::COLOR_1,
        ...
        $this->add_control(
            'social_hover_color',
            [
                'label'     => __('Social Hover Color', 'lexrider-core'),
                'type'      => Controls_Manager::COLOR,
                'scheme'    => [
                    'type'  => Scheme_Color::get_type(),
                    'value' => Scheme_Color::COLOR_1,
...
$widgets_manager->register(new OSF_Elementor_Team());
