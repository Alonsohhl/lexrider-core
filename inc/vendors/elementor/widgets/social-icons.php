...
class OSF_Elementor_Widget_Social_Icons extends Widget_Base {
	...
	public function get_title() {
		return __( 'Social Icons', 'lexrider-core' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_social_icon',
			[
				'label' => __( 'Social Icons', 'lexrider-core' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'default',
				'options' => [
					'default' => __( 'Official Color', 'lexrider-core' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-social-icon:hover i' => 'color: {{VALUE}} !important;',
				],
			]
		);
