...
class OSF_Element_Social_Share extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Social Share', 'lexrider-core' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Share Buttons', 'lexrider-core' ),
            ]
        );
        ...
        $this->add_control(
            'socials',
            [
                'label' => __( 'Select Socials', 'lexrider-core' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'gradient' => __( 'Gradient', 'lexrider-core' ),
                    'minimal' => __( 'Minimal', 'lexrider-core' ),
                    'framed' => __( 'Framed', 'lexrider-core' ),
                    'boxed' => __( 'Boxed Icon', 'lexrider-core' ),
                    'flat' => __( 'Flat', 'lexrider-core' ),
                ],
                'default' => 'gradient',
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'rounded' => __( 'Rounded', 'lexrider-core' ),
        ...
        $this->add_responsive_control(
            'column_gap',
            [
                'label'     => __( 'Columns Gap', 'lexrider-core' ),
        ...
        $this->add_responsive_control(
            'row_gap',
            [
                'label'     => __( 'Rows Gap', 'lexrider-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 10,
                ],
        ...
        $this->add_responsive_control(
            'button_size',
            [
                'label' => __( 'Button Size', 'lexrider-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0.5,
        ...
        $this->add_responsive_control(
            'button_height',
            [
                'label' => __( 'Button Height', 'lexrider-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'em' => [
                        'min' => 1,
        ...
        $this->add_control(
            'text_padding',
            [
                'label' => __( 'Text Padding', 'lexrider-core' ),
            ...
            <?php foreach ( $settings['socials'] as $button ) {
                ...
                <div class="elementor-grid-item">
                    <div class="elementor-share-btn">
                        <a href="<?php $this->render_html_social($button); ?>" target="_blank" title="<?php printf( __('Share on %s', 'lexrider-core'), $title)?>">
