...
class OSF_Elementor_CallToAction extends Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Call to Action', 'lexrider-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Image Resolution', 'lexrider-core' ),
				'default' => 'large',
				'condition' => [
					'bg_image[id]!' => '',
				],
		...
		$this->add_control(
			'graphic_element',
			[
				'label' => __( 'Graphic Element', 'lexrider-core' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => [
					'none' => [
						'title' => __( 'None', 'lexrider-core' ),
						'icon' => 'fa fa-ban',
					],
					'image' => [
						'title' => __( 'Image', 'lexrider-core' ),
						'icon' => 'fa fa-picture-o',
					],
					'icon' => [
						'title' => __( 'Icon', 'lexrider-core' ),
						'icon' => 'fa fa-star',
					],
				],
				'separator' => 'before',
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'lexrider-core' ),
		...
		$this->add_control(
			'link_click',
			[
				'label' => __( 'Apply Link On', 'lexrider-core' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'box' => __( 'Whole Box', 'lexrider-core' ),
					'button' => __( 'Button Only', 'lexrider-core' ),
				],
				'default' => 'button',
				'separator' => 'none',
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Horizontal Position', 'lexrider-core' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => [
					'left' => [
		...
		$this->add_responsive_control(
			'min-height',
			[
				'label' => __( 'Min. Height', 'lexrider-core' ),
		...
		$this->add_responsive_control(
			'image_min_width',
			[
				'label' => __( 'Min. Width', 'lexrider-core' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			'icon_padding',
			[
				'label' => __( 'Icon Padding', 'lexrider-core' ),
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
		...
		$this->add_control(
			'description_color',
			[
				'label' => __( 'Description Color', 'lexrider-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Typography', 'lexrider-core' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .elementor-cta__button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .elementor-cta__button:hover',
            ]
        );
		...
		$this->start_controls_section(
			'hover_effects',
			[
				'label' => __( 'Hover Effects', 'lexrider-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'groups' => [
					[
						'label' => __( 'None', 'lexrider-core' ),
						'options' => [
							'' => __( 'None', 'lexrider-core' ),
						],
					],
					[
						'label' => __( 'Entrance', 'lexrider-core' ),
						'options' => [
					...
					[
						'label' => __( 'Reaction', 'lexrider-core' ),
						'options' => [
							'grow' => 'Grow',
							'shrink' => 'Shrink',
		...
		$this->add_control(
			'sequenced_animation',
			[
				'label' => __( 'Sequenced Animation', 'lexrider-core' ),
		...
		$this->add_control(
			'effect_duration',
			[
				'label' => __( 'Effect Duration', 'lexrider-core' ),
				'type' => Controls_Manager::SLIDER,
				'render_type' => 'template',
				'default' => [
					'size' => 1500,
