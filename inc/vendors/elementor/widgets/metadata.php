...
class OSF_Elementor_Metadata extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Opal Portfolio Metadata', 'lexrider-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'vertical',
                'options' => array(
                    'horizontal' => esc_html__('Horizontal', 'lexrider-core'),
                    'vertical'   => esc_html__('Vertical', 'lexrider-core'),
                ),
            ]
        );
        ...
        $this->add_control(
            'data',
            [
                'label'       => __('Meta Item', 'lexrider-core'),
...
$widgets_manager->register(new OSF_Elementor_Metadata());
