...
class OSF_Widget_Toggle extends Widget_Toggle {
    ...
    protected function register_controls() {
        ...
        $repeater->add_control('tab_title', [
            ...
            'default'     => __('Toggle Title', 'lexrider-core'),
            'label_block' => true,
        ]);
        ...
        $repeater->add_control('tab_content', [
            ...
            'default'    => __('Toggle Content', 'lexrider-core'),
            'show_label' => false,
        ]);
        ...
        $this->add_control(
            'tabs',
            [
                'label'       => __('Toggle Items', 'lexrider-core'),
                'type'        => Controls_Manager::REPEATER,
                'fields'      => $repeater->get_controls(),
                'default'     => [
                    [
                        'tab_title'   => __('Toggle #1', 'lexrider-core'),
                        'tab_content' => __('I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'lexrider-core'),
                    ],
                    [
                        'tab_title'   => __('Toggle #2', 'lexrider-core'),
                        'tab_content' => __('I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'lexrider-core'),
                    ],
                ],
        ...
        $this->add_control(
            'event_type',
            [
                'label'        => __('Event Type', 'lexrider-core'),
                'type'         => Controls_Manager::SELECT,
                'options'      => array(
                    'toggle'    => 'Toggle',
                    'accordion' => 'Accordion'
