...
class OSF_Elementor_Button_Contact_Form extends  Widget_Button {
    ...
    public function get_title() {
        return __('Opal Button Contact Form 7', 'lexrider-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Request A Call Back', 'lexrider-core' ),
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Free consultation', 'lexrider-core' ),
                'separator' => 'before',
            ]
        );
...
$widgets_manager->register(new OSF_Elementor_Button_Contact_Form());