...
class OSF_Elementor_Widget_Button extends Widget_Button
{
    ...
    {
        return __('Button', 'lexrider-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __('Click here', 'lexrider-core'),
            ]
        );
        ...
        $this->add_control(
            'button_css_id',
            [
                'label' => __('Button ID', 'lexrider-core'),
                'type' => Controls_Manager::TEXT,
                'default' => '',
                'title' => __('Add your custom id WITHOUT the Pound key. e.g: my-id', 'lexrider-core'),
                'label_block' => false,
                'description' => __('Please make sure the ID is unique and not used elsewhere on the page this form is displayed. This field allows <code>A-z 0-9</code> & underscore chars without spaces.', 'lexrider-core'),
                'separator' => 'before',
        ...
        $this->start_controls_section(
            'contactform7',
            [
                'label' => __('Contact Form Popup', 'lexrider-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}}.elementor-button-link a.elementor-button:hover, {{WRAPPER}}.elementor-button-link .elementor-button:hover' => 'color: {{VALUE}} !important;',
                ],
                'condition' => [
                    'button_type' => 'link',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'right',
                'options' => [
                    'left' => __('Before', 'lexrider-core'),
                    'right' => __('After', 'lexrider-core'),
                ],
                'condition' => [
                    'icon!' => '',
                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Button Submit', 'lexrider-core' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'contact_slug!' => '',
                ]
