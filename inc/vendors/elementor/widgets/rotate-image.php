...
class OSF_Elementor_Rotate_Image extends Widget_Base {
	...
	public function get_title() {
		return __( 'Opal Rotate Image', 'lexrider-core' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Rotate Image', 'lexrider-core' ),
			]
		);
		...
		$this->add_control(
			'carousel',
			[
				'label' => __( 'Add Images', 'lexrider-core' ),
...
$widgets_manager->register(new OSF_Elementor_Rotate_Image());