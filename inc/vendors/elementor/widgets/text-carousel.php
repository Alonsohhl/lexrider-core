...
class OSF_Elementor_Text_Carousel extends OSF_Elementor_Carousel_Base {
    ...
    public function get_title() {
        return __('Opal Text Carousel', 'lexrider-core');
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control('title', [
            ...
            'default'     => __('Title', 'lexrider-core'),
            'label_block' => true,
        ]);
        ...
        $repeater->add_control('subtitle', [
            ...
            'type'        => Controls_Manager::TEXT,
            'default'     => __('Sub Title', 'lexrider-core'),
            'label_block' => true,
        ]);
        ...
        $this->add_control(
            'contents',
            [
                'label'       => __('Content Item', 'lexrider-core'),
        ...
        $this->add_control(
            'subtitle_position',
            [
                'label'   => __('Subtitle Position', 'lexrider-core'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'after',
                'options' => [
                    'after'  => __('After Title', 'lexrider-core'),
                    'before' => __('Before Title', 'lexrider-core'),
                ],
            ]
        );
        ...
        $this->add_control(
            'subtitle_color',
            [
                'label'     => __('Sub Title Color', 'lexrider-core'),
                'type'      => Controls_Manager::COLOR,
                'scheme'    => [
                    'type'  => Scheme_Color::get_type(),
                    'value' => Scheme_Color::COLOR_3,
