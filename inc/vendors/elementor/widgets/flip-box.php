...
class OSF_Elementor_Flip_Box extends Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Opal Flip Box', 'lexrider-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Front', 'lexrider-core' ),
			]
		);

		$this->start_controls_tabs( 'side_a_content_tabs' );

		$this->start_controls_tab( 'side_a_content_tab', [ 'label' => __( 'Content', 'lexrider-core' ) ] );
		...
		$this->start_controls_tab( 'side_a_background_tab', [ 'label' => __( 'Background', 'lexrider-core' ) ] );
		...
		$this->add_control(
			...
			[
				'label' => __( 'Background Overlay', 'lexrider-core' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Back', 'lexrider-core' ),
			]
		);

		$this->start_controls_tabs( 'side_b_content_tabs' );

		$this->start_controls_tab( 'side_b_content_tab', [ 'label' => __( 'Content', 'lexrider-core' ) ] );
		...
		$this->start_controls_tab( 'side_b_background_tab', [ 'label' => __( 'Background', 'lexrider-core' ) ] );
		...
		$this->add_control(
			'flip_effect',
			[
				'label' => __( 'Flip Effect', 'lexrider-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'flip',
				'options' => [
					'flip' => 'Flip',
		...
		$this->add_control(
			'flip_direction',
			[
				'label' => __( 'Flip Direction', 'lexrider-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'up',
				'options' => [
					'left' => __( 'Left', 'lexrider-core' ),
					'right' => __( 'Right', 'lexrider-core' ),
					'up' => __( 'Up', 'lexrider-core' ),
					'down' => __( 'Down', 'lexrider-core' ),
				],
				'condition' => [
					'flip_effect!' => [
							'fade',
		...
		$this->add_control(
			'flip_3d',
			[
				'label' => __( '3D Depth', 'lexrider-core' ),
		...
		$this->add_control(
			'icon_rotate',
			[
				'label' => __( 'Icon Rotate', 'lexrider-core' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0,
					'unit' => 'deg',
