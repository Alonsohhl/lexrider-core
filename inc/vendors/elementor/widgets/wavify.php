...
class OSF_Elementor_Wavify extends Widget_Base {
	...
	public function get_title() {
		return __( 'Opal Wavify', 'lexrider-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_wavify',
			[
				'label' => __( 'Wavify', 'lexrider-core' ),
			]
		);
		$this->add_responsive_control(
			'wave_wrap_height',
			[
				'label'     => __( 'Wrap Height', 'lexrider-core' ),
		...
		$repeater->add_control(
			'wave_color',
			[
				'label'              => __( 'Wavify Color', 'lexrider-core' ),
				'type'               => Controls_Manager::COLOR,
				'description'        => __( 'Number of articulations in the wave', 'lexrider-core' ),
		...
		$repeater->add_control(
			'wave_amplitude',
			[
				'label'              => __( 'Amplitude', 'lexrider-core' ),
				'type'               => Controls_Manager::NUMBER,
				'default'            => 40,
				'description'        => __( 'Vertical distance wave travels', 'lexrider-core' ),
				'frontend_available' => true,
			]
		);
