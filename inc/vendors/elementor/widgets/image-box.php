...
class OSF_Widget_Image_Box extends Widget_Image_Box {
    ...
    public function get_title() {
        return __('Image Box', 'lexrider-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'placeholder' => __('Enter your sub-title', 'lexrider-core'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_responsive_control(
            'svg_size',
            [
                'label'          => __('SVG Size', 'lexrider-core'),
                'type'           => Controls_Manager::SLIDER,
                'default'        => [
                    'size' => 46,
                    'unit' => 'px',
        ...
        $this->add_control(
            'svg_color',
            [
                'label'     => __('SVG Color', 'lexrider-core'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Box View', 'lexrider-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'view_style!' => 'default',
                ],
        ...
        $this->add_control(
            'view_bg',
            [
                'label'     => __('Box View Background', 'lexrider-core'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'title_color_hover',
            [
                'label'     => __('Color Hover (Wrapper)', 'lexrider-core'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
