...
class OSF_Elementor_Image_Hotspots_Widget extends Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section('image_hotspots_image_section',
            [
                'label' => esc_html__('Image', 'lexrider-core'),
            ]
        );
        ...
        $this->start_controls_section('image_hotspots_icons_settings',
            [
                'label' => esc_html__('Hotspots', 'lexrider-core'),
            ]
        );
        ...
        $repeater->add_control('image_hotspots_icon_type_switch',
            [
                'label'       => esc_html__('Display On', 'lexrider-core'),
                'type'        => Controls_Manager::SELECT,
                'options'     => [
                    'font_awesome_icon' => esc_html__('Font Awesome Icon', 'lexrider-core'),
                    'custom_image'      => esc_html__('Custom Image', 'lexrider-core'),
                    'text'              => esc_html__('Text', 'lexrider-core'),
                ],
        ...
        $repeater->add_control('image_hotspots_font_awesome_icon',
            [
                'label'     => esc_html__('Select Icon', 'lexrider-core'),
        ...
        $repeater->add_control('image_hotspots_custom_image',
            [
                'label'     => esc_html__('Custom Image', 'lexrider-core'),
                'type'      => Controls_Manager::MEDIA,
                'default'   => [
                    'url' => Utils::get_placeholder_image_src(),
                ],
        ...
        $repeater->add_control('image_hotspots_text',
            [
                'label'     => esc_html__('Text', 'lexrider-core'),
        ...
        $repeater->add_responsive_control('preimum_image_hotspots_main_icons_horizontal_position',
            [
                'label'      => esc_html__('Horizontal Position', 'lexrider-core'),
        ...
        $repeater->add_responsive_control('preimum_image_hotspots_main_icons_vertical_position',
            [
                'label'      => esc_html__('Vertical Position', 'lexrider-core'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', '%'],
                'range'      => [
                    'px' => [
        ...
        if (osf_is_woocommerce_activated()) {
            $repeater->add_control('image_hotspots_content',
                [
                    'label'   => esc_html__('Content to Show', 'lexrider-core'),
                    'type'    => Controls_Manager::SELECT,
                    'options' => [
                        'text_editor'         => esc_html__('Text Editor', 'lexrider-core'),
                        'elementor_templates' => esc_html__('Elementor Template', 'lexrider-core'),
                        'elementor_product'   => esc_html__('Product', 'lexrider-core'),
                    ],
                    'default' => 'text_editor'
                ]
            );
        ...
        $repeater->add_control('image_hotspots_tooltips_temp',
            [
                'label'     => esc_html__('Teamplate ID', 'lexrider-core'),
        ...
        $repeater->add_control('image_hotspots_tooltips_product',
            [
                'label'     => __('Product id', 'lexrider-core'),
        ...
        $repeater->add_control('image_hotspots_link_switcher',
            [
                'label'       => esc_html__('Link', 'lexrider-core'),
                'type'        => Controls_Manager::SWITCHER,
                'description' => esc_html__('Add a custom link or select an existing page link', 'lexrider-core'),
            ]);

        $repeater->add_control('image_hotspots_link_type',
            [
                'label'       => esc_html__('Link/URL', 'lexrider-core'),
                'type'        => Controls_Manager::SELECT,
                'options'     => [
                    'url'  => esc_html__('URL', 'lexrider-core'),
                    'link' => esc_html__('Existing Page', 'lexrider-core'),
                ],
                'default'     => 'url',
                'condition'   => [
...
//			] );
        ...
        $repeater->add_control('image_hotspots_url',
            [
                'label'       => esc_html__('URL', 'lexrider-core'),
        ...
        $repeater->add_control('image_hotspots_link_text',
            [
                'label'       => esc_html__('Link Title', 'lexrider-core'),
                'type'        => Controls_Manager::TEXT,
                'dynamic'     => ['active' => true],
                'condition'   => [
                    'image_hotspots_link_switcher' => 'yes',
        ...
        $this->add_control('image_hotspots_icons_animation',
            [
                'label' => esc_html__('Radar Animation', 'lexrider-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->start_controls_section('image_hotspots_tooltips_section',
            [
                'label' => esc_html__('Tooltips', 'lexrider-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'   => esc_html__('Trigger', 'lexrider-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'click' => esc_html__('Click', 'lexrider-core'),
                    'hover' => esc_html__('Hover', 'lexrider-core'),
                ],
                'default' => 'hover'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Show Arrow', 'lexrider-core'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'lexrider-core'),
                'label_off' => esc_html__('Hide', 'lexrider-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Positon', 'lexrider-core'),
                'type'        => Controls_Manager::SELECT2,
                'options'     => [
                    'top'    => esc_html__('Top', 'lexrider-core'),
                    'bottom' => esc_html__('Bottom', 'lexrider-core'),
                    'left'   => esc_html__('Left', 'lexrider-core'),
                    'right'  => esc_html__('Right', 'lexrider-core'),
                ],
                'description' => esc_html__('Sets the side of the tooltip. The value may one of the following: \'top\', \'bottom\', \'left\', \'right\'. It may also be an array containing one or more of these values. When using an array, the order of values is taken into account as order of fallbacks and the absence of a side disables it', 'lexrider-core'),
                'default'     => ['top', 'bottom'],
                'label_block' => true,
                'multiple'    => true
            ]
        ...
        $this->add_control('image_hotspots_tooltips_distance_position',
            [
                'label'   => esc_html__('Spacing', 'lexrider-core'),
                'type'    => Controls_Manager::NUMBER,
                'title'   => esc_html__('The distance between the origin and the tooltip in pixels, default is 6', 'lexrider-core'),
                'default' => 6,
            ]
        );
        ...
        $this->add_control('image_hotspots_min_width',
            [
                'label'       => esc_html__('Min Width', 'lexrider-core'),
                'type'        => Controls_Manager::SLIDER,
                'range'       => [
                    'px' => [
                        'min' => 0,
                ...
                'description' => esc_html__('Set a minimum width for the tooltip in pixels, default: 0 (auto width)', 'lexrider-core'),
            ]
        );

        $this->add_control('image_hotspots_max_width',
            [
                'label'       => esc_html__('Max Width', 'lexrider-core'),
                'type'        => Controls_Manager::SLIDER,
                'range'       => [
                    'px' => [
                        'min' => 0,
                ...
                'description' => esc_html__('Set a maximum width for the tooltip in pixels, default: null (no max width)', 'lexrider-core'),
            ]
        );

        $this->add_responsive_control('image_hotspots_tooltips_wrapper_height',
            [
                'label'       => esc_html__('Height', 'lexrider-core'),
                'type'        => Controls_Manager::SLIDER,
                'size_units'  => ['px', 'em', '%'],
                'range'       => [
                    'px' => [
        ...
        $this->add_control('image_hotspots_anim',
            [
                'label'       => esc_html__('Animation', 'lexrider-core'),
                'type'        => Controls_Manager::SELECT,
                'options'     => [
                    'fade'  => esc_html__('Fade', 'lexrider-core'),
                    'grow'  => esc_html__('Grow', 'lexrider-core'),
                    'swing' => esc_html__('Swing', 'lexrider-core'),
                    'slide' => esc_html__('Slide', 'lexrider-core'),
                    'fall'  => esc_html__('Fall', 'lexrider-core'),
                ],
                'default'     => 'fade',
                'label_block' => true,
            ]
        ...
        $this->add_control('image_hotspots_anim_dur',
            [
                'label'   => esc_html__('Animation Duration', 'lexrider-core'),
                'type'    => Controls_Manager::NUMBER,
                'title'   => esc_html__('Set the animation duration in milliseconds, default is 350', 'lexrider-core'),
                'default' => 350,
            ]
        );
        ...
        $this->add_control('image_hotspots_delay',
            [
                'label'   => esc_html__('Delay', 'lexrider-core'),
                'type'    => Controls_Manager::NUMBER,
                'title'   => esc_html__('Set the animation delay in milliseconds, default is 10', 'lexrider-core'),
                'default' => 10,
            ]
        );
        ...
        $this->add_control('image_hotspots_hide',
            [
                'label'        => esc_html__('Hide on Mobiles', 'lexrider-core'),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => 'Show',
                'label_off'    => 'Hide',
                'description'  => esc_html__('Hide tooltips on mobile phones', 'lexrider-core'),
                'return_value' => true,
            ]
        );
        ...
        $this->add_control('image_hotspots_image_border_radius',
            [
                'label'      => esc_html__('Border Radius', 'lexrider-core'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
        ...
        $this->add_responsive_control('image_hotspots_image_padding',
            [
                'label'      => esc_html__('Padding', 'lexrider-core'),
        ...
        $this->add_responsive_control('preimum_image_hotspots_main_icons_size',
            [
                'label'      => esc_html__('Size', 'lexrider-core'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em'],
                'range'      => [
                    'px' => [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Shadow', 'lexrider-core'),
        ...
        $this->add_responsive_control('image_hotspots_main_icons_margin',
            [
                'label'      => esc_html__('Margin', 'lexrider-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Text Color', 'lexrider-core'),
                'type'      => Controls_Manager::COLOR,
                'scheme'    => [
                    'type'  => Scheme_Color::get_type(),
                    'value' => Scheme_Color::COLOR_2,
        ...
        $this->add_control(
            'image_hotspots_main_text_block',
            [
                'label'     => __('Text Block', 'lexrider-core'),
                'type'      => Controls_Manager::SWITCHER,
                'selectors' => [
                    '{{WRAPPER}} .opal-image-hotspots-main-icons .opal-image-hotspots-text' => 'display: block; width: 1em; height: 1em; line-height: 1em; box-sizing: content-box;',
                ],
            ]
        );
        ...
        $this->add_control('image_hotspots_radar_background',
            [
                'label'     => __('Radar Background Color', 'lexrider-core'),
                'type'      => Controls_Manager::COLOR,
                'scheme'    => [
                    'type'  => Scheme_Color::get_type(),
                    'value' => Scheme_Color::COLOR_1,
        ...
        $this->add_control('image_hotspots_radar_border_radius',
            [
                'label'      => esc_html__('Radar Border Radius', 'lexrider-core'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', '%'],
                'condition'  => [
                    'image_hotspots_icons_animation' => 'yes'
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Hotspots Opacity', 'lexrider-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min'  => 0,
        ...
        $this->add_control('image_hotspots_tooltips_wrapper_background_color',
            [
                'label'     => esc_html__('Background Color', 'lexrider-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
...
//        );
        ...
        $this->start_controls_section('img_hotspots_container_style',
            [
                'label' => esc_html__('Container', 'lexrider-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control('img_hotspots_container_padding',
            [
                'label'      => esc_html__('Paddding', 'lexrider-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
            ...
            <?php foreach ($settings['image_hotspots_icons'] as $index => $item) {
                ...
                <div <?php echo $this->get_render_attribute_string($list_item_key); ?>
                    ...
                    <div class="opal-image-hotspots-tooltips-wrapper">
                        <div class="opal-image-hotspots-tooltips-text tooltip_content"><?php
...
//                                echo '<a href="' . $product->get_permalink() . '" title="' . $product->get_title() . '">' . $product->get_image() . '</a>';
                                $this->get_product_by_id($item['image_hotspots_tooltips_product']);
    ...
    protected function get_product_by_id($id) {
        $args = array('post_type' => 'product', 'p' => $id);
