...
$page_title_font = sanitize_font_weight(get_theme_mod( 'osf_typography_page_title_font_family' ));
...
$breadcrumb_font = sanitize_font_weight(get_theme_mod( 'osf_typography_page_title_breadcrumb_font_family' ));
