                ...
                <nav class="opal-tab-nav">
                    <ul>
                        <li class="tab-current"><a
                                    href="#opal-tab-login"><span><?php esc_html_e( 'Login', 'lexrider-core' ) ?></span></a>
                        </li>
                        <li><a href="#opal-tab-register"><span><?php esc_html_e( 'Register', 'lexrider-core' ) ?></span></a>
                        </li>
                    </ul>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input name="username" type="text"
                                                   ...
                                                   placeholder="<?php esc_attr_e( 'Username', 'lexrider-core' ) ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <span class="input-group-addon">
                                            ...
                                            <input name="password" type="password"
                                                   class="form-control" required
                                                   placeholder="<?php esc_attr_e( 'Password', 'lexrider-core' ) ?>">
                                        </div>
                                    </div>
                                    <div class="checkbox">
                                        <label>
                                            <input name="remember"
                                                   type="checkbox"> <?php _e( 'Remember Me', 'lexrider-core' ) ?>
                                        </label>
                                    </div>
									<?php do_action( 'opalrealestate_captcha', 'login_form' ) ?>
                                    <button type="submit" data-button-action
                                            class="btn btn-primary btn-block"><?php _e( 'Login', 'lexrider-core' ) ?></button>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="username"
                                                   placeholder="<?php esc_html_e( 'Username', 'lexrider-core' ); ?>"
                                                   required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="email"
                                                   placeholder="<?php esc_html_e( 'Email', 'lexrider-core' ); ?>"
                                                   required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control" name="password"
                                                   placeholder="<?php esc_html_e( 'Password', 'lexrider-core' ); ?>"
                                                   required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control" name="password2"
                                                   placeholder="<?php esc_html_e( 'Confirm Password', 'lexrider-core' ); ?>"
                                                   required>
                                        </div>
                                    </div>
									<?php do_action( 'opalrealestate_captcha', 'register_form' ) ?>
                                    <button type="submit" data-button-action
                                            class="btn btn-primary btn-block"><?php _e( 'Register', 'lexrider-core' ) ?></button>
